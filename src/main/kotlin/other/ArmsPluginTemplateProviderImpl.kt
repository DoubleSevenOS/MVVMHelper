...
class ArmsPluginTemplateProviderImpl : WizardTemplateProvider() {
    ...
    val mBaseFragmentName = "BaseFragment"
    val mBaseFragmentPackage = "com.sunmi.sunminewcit.base"

    val mBaseViewModelName = "CommonParamsViewModel"
    val mBaseViewModelPackage = "com.sunmi.sunminewcit.viewmodel"
    ...
    val armsTemplate: Template
        get() = template {
            ...
            recipe = { te ->
                ...
                println("===armsRecipe====")
                if (moduleTemplateData.projectTemplateData.language == Language.Java) {
